...
export default function Home() {
  return (
    <>
      <div className="relative bg-[#131313] h-[940px]  z-10 overflow-hidden">
        ...
        <div className="absolute left-0 bottom-0 w-full h-full"><Image src={line1} alt="line1" fill className="object-cover" /></div>
        <div className="absolute right-0 top-0 w-full h-full"><Image src={line2} alt="line2" fill className="object-cover" /></div>
      <Hero />
      </div>
    </>
  );
